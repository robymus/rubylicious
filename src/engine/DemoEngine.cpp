...
const char *DemoEngine::initialize() {
    ...
    SDL_GL_SetAttribute(SDL_GL_CONTEXT_MAJOR_VERSION, DemoEngine::OPENGL_MAJOR_VERSION);
    SDL_GL_SetAttribute(SDL_GL_CONTEXT_MINOR_VERSION, DemoEngine::OPENGL_MINOR_VERSION);
